...
public class ABookOfillusions extends MouseAdapter {
	...
	public static void main(String[] args) throws Exception {
		ABookOfillusions illusions = new ABookOfillusions();
	...
	private void createBook() {
		...
		String one = "optical-illusion-pods-michael-tompsett.jpg";
