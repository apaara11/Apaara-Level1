...
public class FortuneTeller extends JPanel implements Runnable, MouseListener {
	...
	static void begin() {
		...
		JOptionPane.showMessageDialog(null,
				"Welcome my brethen. You have taken on a horrifying journey that could kill you.");
		JOptionPane.showMessageDialog(null,
				"The secret location is something that you can see. Choose right and succeed.");
	}
